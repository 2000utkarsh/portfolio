$(document).ready(function () {
...

  {
    ...
    demoUrl: "https://vp-shorturl.herokuapp.com",
...

  {
    ...
    description: 'A list of Free Code Camp campers who\'ve earned the most brownie points in the past 30 days.', demoUrl: 'https://codepen.io/vinaypuppal/full/MeJqzJ/',
...

  {
    id: 19,
    title: 'Recipe Book',
    description: 'A list of Recipes that the user can create with name and ingredients.All Recipes are stored in users localstorage', demoUrl: 'https://codepen.io/vinaypuppal/live/pbPabb',
